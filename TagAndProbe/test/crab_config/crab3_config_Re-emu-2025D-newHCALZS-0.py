...
config.General.requestName = '2025D-HCAL-ReEmul-newZS-0'
config.General.workArea = 'Crab3WorkArea'

config.section_("JobType")
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'tau_tagAndProbeRun3_0.py'
config.JobType.allowUndistributedCMSSW = True

config.section_("Data")
config.Data.inputDataset = '/HcalNZS/Run2025D-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset= '/HcalNZS/Run2025D-v1/RAW'
...
config.Data.runRange = '394295-395967'
