...
config.General.requestName = '2025C-HCAL-ReEmul-newZS-0'
...
config.Data.inputDataset = '/HcalNZS/Run2025C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset= '/HcalNZS/Run2025C-v1/RAW'
...
config.Data.runRange = '392159-393108'
