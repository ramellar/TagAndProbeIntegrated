...
config.General.requestName = 'Muon3-2026C'
...
config.Data.inputDataset = '/Muon3/Run2026C-PromptReco-v1/MINIAOD'
...
config.Data.unitsPerJob = 75000 #number of events per jobs
config.Data.totalUnits = -1 #number of event
config.Data.outLFNDirBase = '/store/user/ramellar/tau_run3_2026'
# config.Data.runRange = '402536-403026'
config.Data.lumiMask = '../DataCertificationJsons/Collisions26_13p6TeV_Latest.json'
