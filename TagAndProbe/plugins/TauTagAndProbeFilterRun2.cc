#ifndef TAUTAGANDPROBEFILTERRUN2_H
#define TAUTAGANDPROBEFILTERRUN2_H
...
class TauTagAndProbeFilterRun2 : public edm::stream::EDFilter<> {

    public:
        TauTagAndProbeFilterRun2(const edm::ParameterSet &);
        ~TauTagAndProbeFilterRun2();
...
TauTagAndProbeFilterRun2::TauTagAndProbeFilterRun2(const edm::ParameterSet & iConfig) :
...
TauTagAndProbeFilterRun2::~TauTagAndProbeFilterRun2()
{}

bool TauTagAndProbeFilterRun2::filter(edm::Event & iEvent, edm::EventSetup const& iSetup)
{
...
float TauTagAndProbeFilterRun2::ComputeMT (math::XYZTLorentzVector visP4, const pat::MET& met)
{
...
DEFINE_FWK_MODULE(TauTagAndProbeFilterRun2);
